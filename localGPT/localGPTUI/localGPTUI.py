...
if __name__ == "__main__":
    ...
    #app.config['DEBUG'] = False  # Set to True for debug mode, False otherwise
    #app.config['HOST'] = args.host  # Set the host (0.0.0.0 makes the app accessible externally)
    #app.config['PORT'] = args.port  # Set the desired port
